...
class TransformObservationDictToArray(ConnectorV2):
    """Transform observation dictionary to array.
    
    This connector is used to transform the observation dictionary to a flat array.
    """
    def __init__(
        self,
        ...
        **kwargs,
        ...
        """Initializes a TransformObservationDictToArray instance.
